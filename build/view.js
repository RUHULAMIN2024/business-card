...
/***/ "./src/Components/Backend/theme/BusinessCardEditor.js":
/*!************************************************************!*\
  !*** ./src/Components/Backend/theme/BusinessCardEditor.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const BusinessCardEditor = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `${_utils_data__WEBPACK_IMPORTED_MODULE_3__.prefix} ${theme}`
    ...
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Person Name", "business-card"),
    inlineToolbar: true
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    className: "title",
    tagName: "p",
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    }, icon?.svg ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
      className: "icon",
      ...
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Text", "icon-list"),
      inlineToolbar: true
    }));
  })));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BusinessCardEditor);

/***/ }),

/***/ "./src/Components/Backend/theme/Theme3Editor.js":
/*!******************************************************!*\
  !*** ./src/Components/Backend/theme/Theme3Editor.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Theme3Editor = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    inlineToolbar: true
  }), businessCard.tagline && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    className: "tagline",
    tagName: "p",
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: (0,_bpl_tools_utils_common__WEBPACK_IMPORTED_MODULE_1__.escapeHTML)(`
		...
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", leftLetter?.typo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", contactTextTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", contactTextTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", downloadBtn?.typo)?.googleFontLink}
		...
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${businessCardSl} .left-letter`, leftLetter?.typo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${contactsSl} .text`, contactTextTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${mainSl} .bcb-download-btn`, downloadBtn?.typo)?.styles}
		...
		${businessCardSl}{
			...
			min-height: ${["0px", "0%", "0em", "0rem"].includes(businessCard?.height) ? "auto" : businessCard?.height};
		...
		${businessCardSl} .top-bg{
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(topBg)}
		}
		...
		${headerSl}{
			...
			margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getSpaceCSS)(headerMargin)};
		${theme === "theme8" ? `${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(header?.background)}
			padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getSpaceCSS)(header?.padding)};
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBorderCSS)(header?.border)}
			box-shadow: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getShadowCSS)(header?.shadow)};` : ""}
		...
		${contactsSl} .icon{
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getColorsCSS)(contactIconColors)}
...
/***/ "./src/Components/Frontend/theme/BusinessCard.js":
/*!*******************************************************!*\
  !*** ./src/Components/Frontend/theme/BusinessCard.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/Components/Frontend/theme/Theme3.js":
/*!*************************************************!*\
  !*** ./src/Components/Frontend/theme/Theme3.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   downloadVCard: () => (/* binding */ downloadVCard),
/* harmony export */   generateVCard: () => (/* binding */ generateVCard)
/* harmony export */ });
function generateVCard(attributes) {
  const {
    name = "",
    title = "",
    contacts,
...
function downloadVCard(vcardText, fileName = "vcard.vcf") {
  const blob = new Blob([vcardText], {
    type: "text/vcard"
  });
...
/* harmony import */ var _utils_vcard__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/vcard */ "./src/utils/vcard.js");
